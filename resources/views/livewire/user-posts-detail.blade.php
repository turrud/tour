<div>
    ...
    <x-modal wire:model="showingModal">
        <div class="px-6 py-4">
            ...
            @if($editing) @can('view-any', App\Models\Image::class)
            <x-partials.card class="mt-5 shadow-none bg-gray-50">
                <h4 class="text-sm text-gray-600 font-bold mb-3">Images</h4>
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.user_posts.inputs.name')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.user_posts.inputs.text')
                    </th>
                    <th></th>
                </tr>
            </thead>
