<div>
    <div>
        ...
        <button class="button" wire:click="newTag">
        ...
        <table class="w-full max-w-full mb-4 bg-transparent">
            <thead class="text-gray-700">
                <tr>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.post_tags.inputs.tag_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    <td class="px-4 py-3 text-left">{{ $tag->name ?? '-' }}</td>
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <div class="mt-10 px-4">{{ $postTags->render() }}</div>
                    </td>
                </tr>
            </tfoot>
        </table>
